...
const en = {
  ...
  'ride.searchHere': 'Search or pick on the map',
  'ride.collapse': 'Hide',
  'place.goHere': 'Go here',
  'place.open24': 'Open 24 hours',
  'place.closedToday': 'Closed today',
  'place.today': 'Today',
  'place.nothing': 'Nothing found nearby.',
  'place.catPharmacy': '💊 Pharmacy',
  'place.catCafe': '☕ Cafe',
  'place.catFood': '🍽 Food',
  'place.catAtm': '🏧 ATM',
  'place.catFuel': '⛽ Fuel',
  'place.catShop': '🛒 Shop',
  'ride.seeRoutes': 'See routes',
  'ride.travelTitle': 'How do you want to get there?',
  'ride.modeFoot': 'Walk',
  'ride.modeBike': 'Cycle',
  'ride.modeCar': 'Drive',
  'ride.askShared': 'Ask for a shared ride',
  'ride.changeDest': 'Change destination',
  'ride.soloHint': 'Just you — no driver needed',
  'ride.takeAlong': 'Take passengers along the way',
  'ride.pickMeUp': 'Let a driver pick me up',
  'ride.pickMeUpOn': 'Drivers heading your way can offer you a lift',
  'ride.liftOffer': 'A lift your way',
  'ride.liftMeet': 'Meet {dist} away',
  'ride.liftAccept': 'Get in',
  'ride.liftDecline': 'No thanks',
  'ride.riders': 'Along your route',
  'ride.offerLift': 'Offer a lift',
  'ride.offered': 'Offered',
  'ride.meetHere': 'Meet at the map centre',
  'ride.takeAlongOn': 'Riders along your route will see you',
  'ride.carFormTitle': 'Your car',
  'ride.carFormText': 'Once, so riders know what to look for.',
  'nav.start': 'Start',
  'nav.exit': 'Exit',
  'nav.setFrom': 'Set starting point',
  'nav.fromTitle': 'Where do you start?',
  'nav.fromAddr': 'Starting address (edit if needed)',
  'nav.changeFrom': 'change',
  'nav.myLocation': 'My location',
  'nav.waitGps': 'Waiting for GPS…',
  'nav.rerouting': 'Rerouting…',
  'nav.arrived': 'You have arrived',
  'nav.arriveStep': 'Arrive at your destination',
  'nav.depart': 'Head off',
  'nav.left': 'Turn left',
  'nav.right': 'Turn right',
  'nav.slightLeft': 'Bear left',
  'nav.slightRight': 'Bear right',
  'nav.sharpLeft': 'Turn sharply left',
  'nav.sharpRight': 'Turn sharply right',
  'nav.straight': 'Continue straight',
  'nav.uturn': 'Make a U-turn',
  'nav.roundabout': 'Take the roundabout',
  'nav.merge': 'Merge',
  'nav.onRamp': 'Take the ramp',
  'nav.offRamp': 'Take the exit',
  'nav.onto': '{turn} onto {name}',
  'nav.done': 'Done',
  'ride.fromCentre': 'Times are measured from the city centre — allow location for your own.',
...
const ru = {
  ...
  'ride.whereTo': 'Куда едем?',
  'ride.searchHere': 'Найдите или укажите на карте',
  'ride.collapse': 'Свернуть',
  'place.goHere': 'Поехать сюда',
  'place.open24': 'Круглосуточно',
  'place.closedToday': 'Сегодня закрыто',
  'place.today': 'Сегодня',
  'place.nothing': 'Рядом ничего не найдено.',
  'place.catPharmacy': '💊 Аптека',
  'place.catCafe': '☕ Кафе',
  'place.catFood': '🍽 Еда',
  'place.catAtm': '🏧 Банкомат',
  'place.catFuel': '⛽ АЗС',
  'place.catShop': '🛒 Магазин',
  'ride.seeRoutes': 'Показать маршруты',
  'ride.travelTitle': 'Как хотите добраться?',
  'ride.modeFoot': 'Пешком',
  'ride.modeBike': 'Велосипед',
  'ride.modeCar': 'На авто',
  'ride.askShared': 'Попросить попутку',
  'ride.changeDest': 'Изменить пункт назначения',
  'ride.soloHint': 'Только вы — водитель не нужен',
  'ride.takeAlong': 'Брать попутчиков по пути',
  'ride.pickMeUp': 'Готов подсесть к водителю',
  'ride.pickMeUpOn': 'Водители по пути смогут предложить подвезти',
  'ride.liftOffer': 'Вас готовы подвезти',
  'ride.liftMeet': 'Встреча в {dist} от вас',
  'ride.liftAccept': 'Сажусь',
  'ride.liftDecline': 'Спасибо, нет',
  'ride.riders': 'По пути с вами',
  'ride.offerLift': 'Предложить подвезти',
  'ride.offered': 'Предложено',
  'ride.meetHere': 'Встреча в центре карты',
  'ride.takeAlongOn': 'Пассажиры вдоль маршрута увидят вас',
  'ride.carFormTitle': 'Ваша машина',
  'ride.carFormText': 'Один раз — чтобы пассажиры знали, что искать.',
  'nav.start': 'Старт',
  'nav.exit': 'Выйти',
  'nav.setFrom': 'Задать точку старта',
  'nav.fromTitle': 'Откуда начинаем?',
  'nav.fromAddr': 'Адрес старта (можно изменить)',
  'nav.changeFrom': 'изменить',
  'nav.myLocation': 'Моё местоположение',
  'nav.waitGps': 'Ждём GPS…',
  'nav.rerouting': 'Перестраиваем маршрут…',
  'nav.arrived': 'Вы на месте',
  'nav.arriveStep': 'Прибытие в пункт назначения',
  'nav.depart': 'Начните движение',
  'nav.left': 'Поверните налево',
  'nav.right': 'Поверните направо',
  'nav.slightLeft': 'Держитесь левее',
  'nav.slightRight': 'Держитесь правее',
  'nav.sharpLeft': 'Резко налево',
  'nav.sharpRight': 'Резко направо',
  'nav.straight': 'Продолжайте прямо',
  'nav.uturn': 'Развернитесь',
  'nav.roundabout': 'Проезжайте круг',
  'nav.merge': 'Перестройтесь',
  'nav.onRamp': 'Съезд на трассу',
  'nav.offRamp': 'Съезд с трассы',
  'nav.onto': '{turn} на {name}',
  'nav.done': 'Готово',
  'ride.fromCentre': 'Время считается от центра города — разрешите геолокацию для точного.',
...
const kk = {
  ...
  'ride.whereTo': 'Қайда барамыз?',
  'ride.searchHere': 'Іздеңіз немесе картадан таңдаңыз',
  'ride.collapse': 'Жию',
  'place.goHere': 'Осында бару',
  'place.open24': 'Тәулік бойы',
  'place.closedToday': 'Бүгін жабық',
  'place.today': 'Бүгін',
  'place.nothing': 'Жақын жерде ештеңе табылмады.',
  'place.catPharmacy': '💊 Дәріхана',
  'place.catCafe': '☕ Кафе',
  'place.catFood': '🍽 Тамақ',
  'place.catAtm': '🏧 Банкомат',
  'place.catFuel': '⛽ ЖМБ',
  'place.catShop': '🛒 Дүкен',
  'ride.seeRoutes': 'Бағыттарды көрсету',
  'ride.travelTitle': 'Қалай жеткіңіз келеді?',
  'ride.modeFoot': 'Жаяу',
  'ride.modeBike': 'Велосипед',
  'ride.modeCar': 'Көлікпен',
  'ride.askShared': 'Бірге жүруді сұрау',
  'ride.changeDest': 'Бағытты өзгерту',
  'ride.soloHint': 'Тек сіз — жүргізуші қажет емес',
  'ride.takeAlong': 'Жол бойында жолаушы алу',
  'ride.pickMeUp': 'Жүргізуші мені алып кетсін',
  'ride.pickMeUpOn': 'Жол бойындағы жүргізушілер ұсыныс жасай алады',
  'ride.liftOffer': 'Сізді апарып тастамақ',
  'ride.liftMeet': 'Кездесу {dist} қашықтықта',
  'ride.liftAccept': 'Отырамын',
  'ride.liftDecline': 'Рақмет, жоқ',
  'ride.riders': 'Сізбен бір бағытта',
  'ride.offerLift': 'Апарып тастауды ұсыну',
  'ride.offered': 'Ұсынылды',
  'ride.meetHere': 'Карта ортасында кездесу',
  'ride.takeAlongOn': 'Бағыт бойындағы жолаушылар сізді көреді',
  'ride.carFormTitle': 'Сіздің көлігіңіз',
  'ride.carFormText': 'Бір рет — жолаушылар нені іздейтінін білуі үшін.',
  'nav.start': 'Бастау',
  'nav.exit': 'Шығу',
  'nav.setFrom': 'Бастау нүктесін қою',
  'nav.fromTitle': 'Қайдан бастаймыз?',
  'nav.fromAddr': 'Бастау мекенжайы (өзгертуге болады)',
  'nav.changeFrom': 'өзгерту',
  'nav.myLocation': 'Менің орным',
  'nav.waitGps': 'GPS күтудеміз…',
  'nav.rerouting': 'Бағыт қайта құрылуда…',
  'nav.arrived': 'Сіз жеттіңіз',
  'nav.arriveStep': 'Межелі жерге жету',
  'nav.depart': 'Жолға шығыңыз',
  'nav.left': 'Солға бұрылыңыз',
  'nav.right': 'Оңға бұрылыңыз',
  'nav.slightLeft': 'Солға қарай ұстаныңыз',
  'nav.slightRight': 'Оңға қарай ұстаныңыз',
  'nav.sharpLeft': 'Күрт солға',
  'nav.sharpRight': 'Күрт оңға',
  'nav.straight': 'Тура жүре беріңіз',
  'nav.uturn': 'Кері бұрылыңыз',
  'nav.roundabout': 'Айналма жолмен жүріңіз',
  'nav.merge': 'Ағынға қосылыңыз',
  'nav.onRamp': 'Трассаға шығыңыз',
  'nav.offRamp': 'Трассадан түсіңіз',
  'nav.onto': '{turn}: {name}',
  'nav.done': 'Дайын',
  'ride.fromCentre': 'Уақыт қала орталығынан есептеледі — дәлдігі үшін геолокацияны қосыңыз.',
